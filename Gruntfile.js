    ...
    injector: {
      ...
      local_dependencies: {
        files: {
          ...
          '<%= dirs.dest %>/advanced-techniques.html':
            [
              '<%= dirs.dest %>/assets/js/vendor/**/*.js',
              '<%= dirs.dest %>/assets/js/**/*.js',
              '<%= dirs.dest %>/assets/css/vendor/*.css',
          ...
          '<%= dirs.dest %>/regular-expressions.html':
            [
              '<%= dirs.dest %>/assets/js/vendor/**/*.js',
              '<%= dirs.dest %>/assets/js/**/*.js',
              '<%= dirs.dest %>/assets/css/vendor/*.css',
          ...
          '<%= dirs.dest %>/html-document-object-model.html':
            [
              '<%= dirs.dest %>/assets/js/vendor/**/*.js',
              '<%= dirs.dest %>/assets/js/**/*.js',
              '<%= dirs.dest %>/assets/css/vendor/*.css',
